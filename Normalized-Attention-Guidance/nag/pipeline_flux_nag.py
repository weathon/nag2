...
from nag.attention_flux_nag import NAGFluxAttnProcessor2_0
from nag.normalization import TruncAdaLayerNormZero, TruncAdaLayerNormContinuous
...
class NAGFluxPipeline(FluxPipeline):
    ...
    def __call__(
        ...
        nag_guidance_type: str = "cfg_norm",
        nag_end: float = 1.0,
        ...
        if self.do_normalized_attention_guidance:
            self._set_nag_attn_processor(self._nag_scale, prompt_embeds.shape[1], nag_tau, nag_alpha, nag_guidance_type)
